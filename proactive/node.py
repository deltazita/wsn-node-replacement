# this class describes a wireless node and it is used by readFile.py
                    ...
                    if node.getStatus() == 'sensor':
                        ...
                        for dep in node.getDependents():
                            if dep in neigh.getDependents():
                                neigh.getDependents().remove(dep) #
                                if dep not in temp:
                                    temp.append(dep)
                                neigh.calcConsumption()
                                neigh.calcEnergyThreshold()
...
class Node:
    ...
    def getMaxConsumption(self):
        return self.maxconsumption

    def setMaxConsumption(self, c):
        self.maxconsumption = c
